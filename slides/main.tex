...
%========================================================================================
%	附录：对 PageIndex 项目的路径分析
%========================================================================================

\section*{附录：对 PageIndex 项目的路径分析}

% ---------- 项目整体介绍 ----------

\begin{frame}
\frametitle{附录 - PageIndex 项目简介}
...
\begin{frame}[fragile]
\frametitle{附录 - 核心搜索流程（\texttt{search.py}）}
...
\begin{frame}[fragile]
\frametitle{附录 - 核心搜索流程续（\texttt{search.py}）}
...
\begin{frame}[fragile]
\frametitle{附录 - 对话式入口（\texttt{agent\_pageindex.py}）}
...
\begin{frame}[fragile]
\frametitle{附录 - 对真实项目运行 PathTracer（1/3）：静态分析}
...
\begin{frame}[fragile]
\frametitle{附录 - 对真实项目运行 PathTracer（2/3）：动态追踪}
...
\begin{frame}[fragile]
\frametitle{附录 - 对真实项目运行 PathTracer（3/3）：覆盖率计算}
