...
Path=fonts/,
BoldFont=AdobeHeitiStd-Regular.otf
]{AdobeHeitiStd-Regular.otf}	%设置默认字体，防止报警
\setCJKmonofont[
Path=fonts/,
ItalicFont=AdobeKaitiStd-Regular.otf
]{AdobeFangsongStd-Regular.otf} %设置默认字体，防止报警
...
\title{\vspace{-1.5cm} \bf\xiaoerhao 代码覆盖率及路径分析检测工具}
\author{\bf\sihao 徐宇鸿}
\date{}
...
\fancyhead[LE]{}
\fancyhead[LO]{}
\fancyhead[CO]{\wuhao{华南理工大学课程论文}}
\fancyhead[CE]{\wuhao{代码覆盖率及路径分析检测工具}}% 
